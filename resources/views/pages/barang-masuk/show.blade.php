    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <!-- Page pre-title -->
                    <div class="page-pretitle">Barang Masuk</div>
                </div>
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <!-- Edit Button Pink -->
                        <a href="{{ route('barang-masuk.edit', $barangMasuk) }}" class="btn btn-pink d-none d-sm-inline-block">
                            <i class="ti ti-edit icon me-2"></i> Edit
                        </a>

                        <!-- Delete Button tetap Merah -->
                        ...
                        <a href="{{ route('barang-masuk.create') }}" class="btn btn-pink d-sm-none btn-icon"
                            ...
                            <table class="table table-transparent table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-bold text-end text-nowrap">Rp. {{ number_format($barangMasuk->total_harga) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
