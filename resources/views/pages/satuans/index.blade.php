        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('satuans.create') }}" class="btn btn-pink d-none d-sm-inline-block">
                        ...
                        <a href="{{ route('satuans.create') }}" class="btn btn-pink d-sm-none btn-icon"
...
@push('custom_script')
    ...
    <!-- Custom CSS untuk tombol pink -->
    <style>
        .btn.btn-pink {
            background-color: #f74f9d !important;
            color: #fff !important;
            border-color: #f74f9d !important;
        }
