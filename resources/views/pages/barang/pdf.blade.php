    ...
    <table style="width:100%">
        <tr>
            <td style="text-align: right; width: 100px;">
                @php
                    // path logo di folder public/img
                    $logoPath = public_path('dist/img/kopthera.png');

                    // cek dulu apakah file ada
                    if (file_exists($logoPath)) {
                        $imageData = base64_encode(file_get_contents($logoPath));
                    } else {
                        $imageData = ''; // jika tidak ada, kosongkan
                    }
                @endphp
                <img width="100px" height="100px" src="data:image/png;base64,{{ $imageData }}" alt="Logo">
            </td>

             <td style="text-align: center; width: 200px;">

                <div style="font-size: 24px">Thera Art Space</div>
                <div style="font-size: 24px"></div>
                <div style="font-size: 16px">Jl. Merdeka No.8, Brubahan, Purwanegara, Kec.Purwokerto Tim., Kab.Banyumas</div>
                <div style="font-size: 16px">WA : 0851 8305 3024</div>
                <div style="font-size: 16px">Email : thera.activities@gmail.com</div>
            </td>
