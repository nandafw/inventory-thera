                    ...
                    <div class="card card-md">
                        <form action="{{ route('barang.update', $barang) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}"
                                                class="form-control @error('nama_barang') is-invalid @enderror" autofocus>
                                            @error('nama_barang')
                                            ...
                                            <select name="satuan_id"
                                                ...
                                                @foreach ($satuans as $item)
                                                    <option value="{{ $item->id }}"
                                                        @selected(old('satuan_id', $barang->satuan_id) == $item->id)>
                                                        {{ $item->nama_satuan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="kategori_id[]"
                                                ...
                                                @foreach ($kategoris as $item)
                                                    <option value="{{ $item->id }}"
                                                        @selected(in_array($item->id, old('kategori_id', $barang->kategoris->pluck('id')->toArray())))>
                                                        {{ $item->nama_kategori }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn" style="background-color:#f74f9d; color:white; width:25%; margin-left:12px;">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
