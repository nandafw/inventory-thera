                                    ...
                                    @forelse ($barangKeluars as $row)
                                        <tr>
                                            ...
                                            <td class="align-text-top" data-label="No. Transaksi">
                                                <a href="{{ route('barang-keluar.show', $row->id) }}">{{ $row->no_transaksi }}</a>
                                            </td>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('barang-keluar.edit', $row->id) }}">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item" href="#"
                                                       style="color:#f74f9d;"
                                                       onmouseover="this.style.backgroundColor='#f74f9d'; this.style.color='#fff';"
                                                       onmouseout="this.style.backgroundColor=''; this.style.color='#f74f9d';"
