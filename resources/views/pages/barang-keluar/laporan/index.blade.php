        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="#" class="btn" 
                           style="border-color: #727272; color: #fff; background-color: #727272;"
                           onmouseover="this.style.backgroundColor='#fff'; this.style.color='#727272'; border:1px solid #f74f9d;"
                           onmouseout="this.style.backgroundColor='#727272'; this.style.color='#fff'; border:none;"
                        ...
                        <a href="{{ route('barang-keluar.laporan.pdf', [
                           ...
                           style="border-color: #f74f9d; color: #fff; background-color: #f74f9d;"
                           onmouseover="this.style.backgroundColor='#fff'; this.style.color='#f74f9d'; border:1px solid #f74f9d;"
                           onmouseout="this.style.backgroundColor='#f74f9d'; this.style.color='#fff'; border:none;">
                        ...
                        <a href="{{ route('barang-keluar.create') }}" class="btn btn-icon d-sm-none" 
                           style="border-color: #f74f9d; color: #fff; background-color: #f74f9d;"
                           onmouseover="this.style.backgroundColor='#fff'; this.style.color='#f74f9d'; border:1px solid #f74f9d;"
                           onmouseout="this.style.backgroundColor='#f74f9d'; this.style.color='#fff'; border:none;"
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Barang">
                                                <div class="d-flex flex-column align-items-top">
                                                    <div class="font-weight-medium">{{ $row->barangKeluar->tgl_keluar }}</div>
                                                    <div class="text-secondary">
                                                        <a href="{{ route('barang-keluar.show', $row->barangKeluar->id) }}"
                                                           target="_blank">{{ $row->barangKeluar->no_transaksi }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td data-label="Barang">
